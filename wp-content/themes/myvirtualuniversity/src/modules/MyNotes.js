...
class MyNotes {
    constructor () {
        if (document.querySelector("#my-notes")) {
            axios.defaults.headers.common["X-WP-Nonce"] = universityData.nonce    // this is for authorization
    ...
    makeNoteReadOnly (thisNote) {
        ...
        thisNote.querySelector(".note-title-field").setAttribute("readonly", "true")    /*1st arg is the name, 2nd is the value*/
    ...
    async deleteNote (e) {
        ...
        try {
            const response = await axios.delete(universityData.root_url /*this is a very useful API method written in functions.php => wp_localize_script()*/ + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"))
