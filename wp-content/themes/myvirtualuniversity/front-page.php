...
<!-- TOP BANNER -->
    <div class="page-banner">
        ...
        <div class="page-banner__content container t-center c-white">
            <h1 class="headline headline--large">Testing site KNOWLEDGE and CONSCIOUSNESS!!</h1>
                ...
                <!-- order the list by 'event_date' -->
                    <?php 
                        ...
                        while($homepageEvents->have_posts()) {      // -> is used to access 'props' and 'methods' for 'Objects'
                            ...
                            get_template_part('template-parts/content', get_post_type());   // in this case. 'get_post_type()' returns 'event', but when this get_template_part() is used in a different context, 
                                                                                                                                // it can work very dynamically to apply all different template-part-files in the template-parts folder
                        }
                    ?>
...
<!-- FROM OUR BLOGS SECTION -->
        <div class="full-width-split__two">
            <div class="full-width-split__inner">
                ...
                <!-- order the list by 'default' of the most recently posted dates -->
                <?php 
                ...
                <?php 
                    ...
                    wp_reset_postdata();    // custom-query hijacks the global post data, so it needs to be reset back to the global default-URL-query
                ?>
